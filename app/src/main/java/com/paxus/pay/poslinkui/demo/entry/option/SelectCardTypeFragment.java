...
public class SelectCardTypeFragment extends AOptionsDialogFragment{
    public static SelectCardTypeFragment newInstance(Intent intent){
        SelectCardTypeFragment dialogFragment = new SelectCardTypeFragment();
    ...
    protected String formatTitle(String action) {
        return requireContext().getString(R.string.select_card_type);
    }
