...
public class SelectAidFragment extends AOptionsDialogFragment{
    public static SelectAidFragment newInstance(Intent intent){
        SelectAidFragment dialogFragment = new SelectAidFragment();
