...
public class ConfirmSignatureMatchFragment extends AConfirmationDialogFragment{
    public static ConfirmSignatureMatchFragment newInstance(Intent intent){
        ConfirmSignatureMatchFragment dialogFragment = new ConfirmSignatureMatchFragment();
