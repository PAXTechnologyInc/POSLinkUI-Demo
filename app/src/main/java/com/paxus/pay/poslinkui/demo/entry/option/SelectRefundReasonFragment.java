...
public class SelectRefundReasonFragment extends AOptionsDialogFragment{
    public static SelectRefundReasonFragment newInstance(Intent intent){
        SelectRefundReasonFragment dialogFragment = new SelectRefundReasonFragment();
