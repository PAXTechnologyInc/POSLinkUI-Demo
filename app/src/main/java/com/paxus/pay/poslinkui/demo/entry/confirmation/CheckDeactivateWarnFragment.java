...
/**
 * Implement confirmation entry action{@link ConfirmationEntry#ACTION_CHECK_DEACTIVATE_WARN} <br>
 * <p>
 * UI Tips:
 ...
 * </p>
 */
public class CheckDeactivateWarnFragment extends AConfirmationDialogFragment {
    ...
    protected String formatMessage() {
        return !TextUtils.isEmpty(message) ? message : getString(R.string.confirm_deactivate_warn);
    }
}
