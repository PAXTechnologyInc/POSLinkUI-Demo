...
public class CsPhoneNumberFragment extends ANumFragment{
    public static CsPhoneNumberFragment newInstance(Intent intent){
        CsPhoneNumberFragment fragment = new CsPhoneNumberFragment();
    ...
    protected void loadArgument(@NonNull Bundle bundle) {
        ...
        String valuePatten = "";
        if(TextEntry.ACTION_ENTER_CS_PHONE_NUMBER.equals(action)) {
