...
public class SelectSubTransTypeFragment extends AOptionsDialogFragment{
    public static SelectSubTransTypeFragment newInstance(Intent intent){
        SelectSubTransTypeFragment dialogFragment = new SelectSubTransTypeFragment();
