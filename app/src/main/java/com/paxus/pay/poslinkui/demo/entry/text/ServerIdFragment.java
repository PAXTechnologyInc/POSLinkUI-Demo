...
public class ServerIdFragment extends ANumFragment{
    public static ServerIdFragment newInstance(Intent intent){
        ServerIdFragment fragment = new ServerIdFragment();
    ...
    protected void loadArgument(@NonNull Bundle bundle) {
        ...
        String valuePatten = "";
        if(TextEntry.ACTION_ENTER_SERVER_ID.equals(action)) {
