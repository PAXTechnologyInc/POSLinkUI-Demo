...
public class ConfirmAdjustTipFragment extends AConfirmationDialogFragment{
    public static ConfirmAdjustTipFragment newInstance(Intent intent){
        ConfirmAdjustTipFragment dialogFragment = new ConfirmAdjustTipFragment();
