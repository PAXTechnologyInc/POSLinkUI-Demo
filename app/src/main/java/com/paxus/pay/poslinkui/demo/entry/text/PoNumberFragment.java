...
public class PoNumberFragment extends ATextFragment{
    public static PoNumberFragment newInstance(Intent intent){
        PoNumberFragment fragment = new PoNumberFragment();
    ...
    protected void loadArgument(@NonNull Bundle bundle) {
        ...
        String valuePatten = "";
        if(TextEntry.ACTION_ENTER_PO_NUMBER.equals(action)){
