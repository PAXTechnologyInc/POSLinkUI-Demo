...
public class ConfirmMerchantScopeFragment extends AConfirmationDialogFragment{
    public static ConfirmMerchantScopeFragment newInstance(Intent intent){
        ConfirmMerchantScopeFragment dialogFragment = new ConfirmMerchantScopeFragment();
    ...
    protected String formatMessage(String action, String message, Bundle bundle) {
        return getString(R.string.confirm_merchant_scope);
    }
