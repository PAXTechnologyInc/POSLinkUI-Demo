...
public class SelectEdcGroupFragment extends AOptionsDialogFragment{
    public static SelectEdcGroupFragment newInstance(Intent intent){
        SelectEdcGroupFragment dialogFragment = new SelectEdcGroupFragment();
    ...
    protected String formatTitle(String action) {
        return requireContext().getString(R.string.select_edc_type);
    }
