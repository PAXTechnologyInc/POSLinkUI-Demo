...
public class SelectEdcTypeFragment extends AOptionsDialogFragment{
    public static SelectEdcTypeFragment newInstance(Intent intent){
        SelectEdcTypeFragment dialogFragment = new SelectEdcTypeFragment();
