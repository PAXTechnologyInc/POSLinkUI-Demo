...
/**
 * Implement confirmation entry action {@value ConfirmationEntry#ACTION_CONFIRM_ONLINE_RETRY}
 * <p>
 * UI Tips:
 ...
 * </p>
 */
public class ConfirmOnlineRetryFragment extends AConfirmationDialogFragment {
    ...
    protected String formatMessage() {
        return !TextUtils.isEmpty(message) ? message : getString(R.string.confirm_online_retry);
    }
