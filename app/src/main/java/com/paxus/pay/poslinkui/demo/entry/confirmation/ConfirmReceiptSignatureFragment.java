...
public class ConfirmReceiptSignatureFragment extends AConfirmationDialogFragment{
    public static ConfirmReceiptSignatureFragment newInstance(Intent intent){
        ConfirmReceiptSignatureFragment dialogFragment = new ConfirmReceiptSignatureFragment();
