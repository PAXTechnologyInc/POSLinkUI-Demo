...
public class OctReferenceNumberFragment extends ANumTextFragment{
    public static OctReferenceNumberFragment newInstance(Intent intent){
        OctReferenceNumberFragment fragment = new OctReferenceNumberFragment();
    ...
    protected void loadArgument(@NonNull Bundle bundle) {
        ...
        String valuePatten = "";
        if(TextEntry.ACTION_ENTER_OCT_REFERENCE_NUMBER.equals(action)){
