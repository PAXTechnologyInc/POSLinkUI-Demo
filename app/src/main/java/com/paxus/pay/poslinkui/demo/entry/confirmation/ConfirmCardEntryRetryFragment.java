...
public class ConfirmCardEntryRetryFragment extends AConfirmationDialogFragment{
    public static ConfirmCardEntryRetryFragment newInstance(Intent intent){
        ConfirmCardEntryRetryFragment dialogFragment = new ConfirmCardEntryRetryFragment();
    ...
    protected String formatMessage(String action, String message, Bundle bundle) {
        return getString(R.string.confirm_card_entry_retry);
    }
