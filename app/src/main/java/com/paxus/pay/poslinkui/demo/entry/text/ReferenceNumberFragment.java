...
public class ReferenceNumberFragment extends ANumTextFragment{
    public static ReferenceNumberFragment newInstance(Intent intent){
        ReferenceNumberFragment fragment = new ReferenceNumberFragment();
    ...
    protected void loadArgument(@NonNull Bundle bundle) {
        ...
        String valuePatten = "";
        if(TextEntry.ACTION_ENTER_REFERENCE_NUMBER.equals(action)){
