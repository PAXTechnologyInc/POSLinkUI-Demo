...
public class DestZipcodeFragment extends ANumTextFragment{
    public static DestZipcodeFragment newInstance(Intent intent){
        DestZipcodeFragment fragment = new DestZipcodeFragment();
    ...
    protected void loadArgument(@NonNull Bundle bundle) {
        ...
        String valuePatten = "";
        if(TextEntry.ACTION_ENTER_DEST_ZIPCODE.equals(action)){
