...
public class ConfirmUploadRetryFragment extends AConfirmationDialogFragment{
    public static ConfirmUploadRetryFragment newInstance(Intent intent){
        ConfirmUploadRetryFragment dialogFragment = new ConfirmUploadRetryFragment();
