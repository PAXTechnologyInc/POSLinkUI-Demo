...
public class SelectReportTypeFragment extends AOptionsDialogFragment{
    public static SelectReportTypeFragment newInstance(Intent intent){
        SelectReportTypeFragment dialogFragment = new SelectReportTypeFragment();
