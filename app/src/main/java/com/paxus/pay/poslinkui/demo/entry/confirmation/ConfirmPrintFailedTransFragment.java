...
public class ConfirmPrintFailedTransFragment extends AConfirmationDialogFragment{
    public static ConfirmPrintFailedTransFragment newInstance(Intent intent){
        ConfirmPrintFailedTransFragment dialogFragment = new ConfirmPrintFailedTransFragment();
