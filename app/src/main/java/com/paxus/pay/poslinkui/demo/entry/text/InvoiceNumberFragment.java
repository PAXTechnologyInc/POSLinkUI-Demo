...
public class InvoiceNumberFragment extends ANumTextFragment{
    public static InvoiceNumberFragment newInstance(Intent intent){
        InvoiceNumberFragment fragment = new InvoiceNumberFragment();
    ...
    protected void loadArgument(@NonNull Bundle bundle) {
        ...
        String valuePatten = "";
        if(TextEntry.ACTION_ENTER_INVOICE_NUMBER.equals(action)){
