...
public class OrderNumberFragment extends ATextFragment{
    public static OrderNumberFragment newInstance(Intent intent){
        OrderNumberFragment fragment = new OrderNumberFragment();
    ...
    protected void loadArgument(@NonNull Bundle bundle) {
        ...
        String valuePatten = "";
        if(TextEntry.ACTION_ENTER_ORDER_NUMBER.equals(action)){
