...
public class SelectMotoTypeFragment extends AOptionsDialogFragment{
    public static SelectMotoTypeFragment newInstance(Intent intent){
        SelectMotoTypeFragment dialogFragment = new SelectMotoTypeFragment();
    ...
    protected String formatTitle(String action) {
        return requireContext().getString(R.string.select_moto_type);
    }
