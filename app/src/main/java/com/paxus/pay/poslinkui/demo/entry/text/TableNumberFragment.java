...
public class TableNumberFragment extends ANumFragment{
    public static TableNumberFragment newInstance(Intent intent){
        TableNumberFragment fragment = new TableNumberFragment();
    ...
    protected void loadArgument(@NonNull Bundle bundle) {
        ...
        String valuePatten = "";
        if(TextEntry.ACTION_ENTER_TABLE_NUMBER.equals(action)) {
