...
public class ReversePartialApprovalFragment extends AConfirmationDialogFragment{
    public static ReversePartialApprovalFragment newInstance(Intent intent){
        ReversePartialApprovalFragment dialogFragment = new ReversePartialApprovalFragment();
