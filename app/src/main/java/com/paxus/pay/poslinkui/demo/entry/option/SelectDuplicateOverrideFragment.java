...
public class SelectDuplicateOverrideFragment extends AOptionsDialogFragment{
    public static SelectDuplicateOverrideFragment newInstance(Intent intent){
        SelectDuplicateOverrideFragment dialogFragment = new SelectDuplicateOverrideFragment();
