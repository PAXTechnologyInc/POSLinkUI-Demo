...
public class ConfirmPrintCustomerCopyFragment extends AConfirmationDialogFragment{
    public static ConfirmPrintCustomerCopyFragment newInstance(Intent intent){
        ConfirmPrintCustomerCopyFragment dialogFragment = new ConfirmPrintCustomerCopyFragment();
