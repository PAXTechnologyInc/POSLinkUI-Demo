...
public class ConfirmCardProcessResultFragment extends AConfirmationDialogFragment{
    public static ConfirmCardProcessResultFragment newInstance(Intent intent){
        ConfirmCardProcessResultFragment dialogFragment = new ConfirmCardProcessResultFragment();
