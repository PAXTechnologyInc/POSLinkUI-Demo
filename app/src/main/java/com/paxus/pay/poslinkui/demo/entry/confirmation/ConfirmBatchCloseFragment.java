...
/**
 * Implement confirmation entry action {@value ConfirmationEntry#ACTION_CONFIRM_BATCH_CLOSE}
 * <p>
 * UI Tips:
 ...
 * </p>
 */
public class ConfirmBatchCloseFragment extends AConfirmationDialogFragment {
    ...
    protected String formatMessage() {
        return !TextUtils.isEmpty(message) ? message : getString(R.string.confirm_batch_close);
    }
}
