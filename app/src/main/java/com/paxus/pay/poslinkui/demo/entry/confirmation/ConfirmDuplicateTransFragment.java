...
/**
 * Implement confirmation entry action {@value ConfirmationEntry#ACTION_CONFIRM_DUPLICATE_TRANS}
 * <p>
 * UI Tips:
 ...
 * </p>
 */
public class ConfirmDuplicateTransFragment extends AConfirmationDialogFragment {
    ...
    protected String formatMessage() {
        return !TextUtils.isEmpty(message) ? message : getString(R.string.prompt_confirm_dup_transaction);
    }
