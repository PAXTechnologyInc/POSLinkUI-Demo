...
/**
 * Implement confirmation entry action {@value ConfirmationEntry#ACTION_CONFIRM_DELETE_SF}
 * <p>
 * UI Tips:
 ...
 * </p>
 */
public class ConfirmDeleteSfFragment extends AConfirmationDialogFragment {
    ...
    protected String formatMessage() {
        return !TextUtils.isEmpty(message) ? message : getString(R.string.confirm_delete_sf);
    }
}
