 ...
 * 4.Update confirm button status when received SecurityStatus
 * 5.Update entry mode when received CardStatus.CARD_INSERT_REQUIRED, CardStatus.CARD_TAP_REQUIRED,CardStatus.CARD_SWIPE_REQUIRED:
 * </p>
 */
...
public class ManageInputAccountFragment extends BaseEntryFragment {
    ...
    protected int getLayoutResourceId() {
        return R.layout.fragment_manage_input_account;
    }
