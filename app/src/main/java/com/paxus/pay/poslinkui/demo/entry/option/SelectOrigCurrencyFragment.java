...
public class SelectOrigCurrencyFragment extends AOptionsDialogFragment{
    public static SelectOrigCurrencyFragment newInstance(Intent intent){
        SelectOrigCurrencyFragment dialogFragment = new SelectOrigCurrencyFragment();
